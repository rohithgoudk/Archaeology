...
export default function Footer() {
  ...
  return (
    <footer className="ftr">
      ...
      <div className="ftr-band">
        <div className="ftr-container ftr-band-inner">
          <div className="ftr-band-text">
            <p className="ftr-band-label">Field Dispatch</p>
            <p className="ftr-band-title">
              Get discoveries delivered <em>before they're published.</em>
            </p>
          </div>
      ...
      <div className="ftr-main">
        <div className="ftr-container">
          ...
          <div className="ftr-brand">
            <Link to="/" className="ftr-logo" aria-label="Strata home">
            ...
            <p className="ftr-brand-desc">
              Uncovering the human story, one careful layer at a time. Field
              archaeology since 1923.
            </p>
            ...
            <div className="ftr-col">
              ...
              <ul className="ftr-col-list ftr-contact-list">
                <li>
                  ...
                  <a href="mailto:stackly@archaeology.org" className="ftr-col-link">
                    stackly@archaeology.org
                  </a>
                </li>
                <li>
      ...
      <div className="ftr-wordmark" aria-hidden="true">STRATA</div>

      {/* ── BOTTOM BAR ── */}
      <div className="ftr-bar">
        <div className="ftr-container ftr-bar-inner">
          <span>© 2025 Strata Archaeological Society. All rights reserved.</span>
          ...
          <span className="ftr-bar-tagline">Est. 1923 · Field Archaeology</span>
        </div>
      </div>
